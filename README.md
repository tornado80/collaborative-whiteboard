...
```
cd existing_repo
git remote add origin https://version.aalto.fi/gitlab/pulkkip7/whiteboard-c.git
git branch -M main
...
- [ ] [Set up project integrations](https://version.aalto.fi/gitlab/pulkkip7/whiteboard-c/-/settings/integrations)
